...
if __name__ == "__main__":
    setup(
        ...
        author="Philipp Wiesner - LEAF , Rishabh Mathur - Using LEAF for scenarios to modelling estimations in the study",
        ...
        project_urls={
            "Bug"
            " Tracker": "https://github.com/dos-group/leaf/issues",
